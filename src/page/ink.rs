...
impl InkBuilder {
    ...
    pub(crate) fn push(&mut self, ink: &Ink, display_bounding_box: Option<&InkBoundingBox>) {
        ...
        // ink having a specific size for correct positioning. Using the width_px/height_px of the
        // actual content often results in an incorrect bounding box and incorrectly-positioned ink.
    ...
    fn build(&self) -> String {
        ...
        if self.embedded {
            ...
            // that embedded ink that comes after this ink has the correct position.
